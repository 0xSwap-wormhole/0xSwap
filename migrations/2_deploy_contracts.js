...
module.exports = async function(_deployer, network, accounts) {
    ...
    if(network == "ropsten") {
        ...
        if (isNewPosManager) {
            await
            _deployer.deploy(PositionManager,uniRouterAddr, "0xswap PosMgr V0", "GAMPOS-VO", {from: accounts[0]});
        ...
        console.log(res);
            ...
            if(isNewPosManager) {
                await _deployer.deploy(PositionManager, uniRouterAddr, "0xswap PosMgr V0", "GAMPOS-VO", { from: accounts[0] });
        ...
        await _deployer.deploy(PositionManager, uniRouter.address, "0xswap PosMgr V0", "GAMPOS-VO", { from: accounts[0] });
