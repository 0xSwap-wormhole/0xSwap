 ...
 contract('PositionManager', (accounts) => {
     ...
     /*it('mint::failUnderCollateralized', async () => {
         ...
         let liquidity = expandTo18Decimals(2);
         //const res =
             await posManager.openPosition(token0.address, token1.address, constants.Zero, constants.Zero, liquidity, accounts[0]).should.be.rejectedWith('0xswapPosLibrary:: INSUFFICIENT_COLLATERAL_DEPOSITED');
         console.log("res >> ");
         //console.log(res);
     });/**/
